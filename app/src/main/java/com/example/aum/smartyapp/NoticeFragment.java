 ...
 */
public class NoticeFragment extends Fragment   implements  RecyclerAdapter_Notice.MessageAdapterListener {
   // private List<DataItem> listSuperHeroes;
    String GET_JSON_DATA_HTTP_URL = "http://192.168.56.1/Android/notice.php";
    ...
    private RecyclerAdapter_Notice mAdapter;
    TextView t1,t2,t3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v=inflater.inflate(R.layout.notice,container,false);
    ...
    private void parseData(String array) throws JSONException {
        ...
        mAdapter = new RecyclerAdapter_Notice(getContext(),messages,this);
