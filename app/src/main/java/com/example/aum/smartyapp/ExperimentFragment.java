 ...
 */
public class ExperimentFragment extends Fragment  implements  RecyclerAdapter_Expi.MessageAdapterListener{
    private List<Message> messages;
    String GET_JSON_DATA_HTTP_URL = "http://192.168.56.1/Android/expi.php";
    ...
    private RecyclerAdapter_Expi mAdapter;
    TextView t1,t2,t3;
    String sem1,stream,s_sem, s_branch,msg,name,fname,url;;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v=inflater.inflate(R.layout.experiment,container,false);
    ...
    private void parseData(String array) throws JSONException {
        ...
        mAdapter = new RecyclerAdapter_Expi(getContext(),messages,this);
