 ...
 */
public class DownloadTaskBus {

    String downloadDirectory = "Info. Sender";
    String mainUrl = "http://192.168.56.1/infosender/admin/";
    private String TAG = "Download Task";
    private Context context;
    private Button buttonText;
    private String downloadUrl = "", downloadFileName = "";

    public DownloadTaskBus(Context context, Button buttonText, String downloadUrl) {
