...
//        notificationIntent.putExtra(MainListAdapter.IS_EMERGENCY, true);
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        if (names.get(position).toString().equals("ATTENDANCE")) {
        ...
        } else if (names.get(position).toString().equals("ATTENDANCE CALCULATION")) {
            ...
            anim.setRepeatCount(Animation.INFINITE);
            imageView.startAnimation(anim);
        } else if (names.get(position).toString().equals("Student Detail")) {
            imageView.setImageResource(R.drawable.ic_profile);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent launchinIntent = new Intent(activity, Findstudent.class);
                    activity.startActivity(launchinIntent);
                }
            });
            Animation anim = new ScaleAnimation(
            ...
            anim.setRepeatCount(Animation.INFINITE);
            imageView.startAnimation(anim);
        } else if (names.get(position).toString().equals("Your Profile")) {
            imageView.setImageResource(R.drawable.ic_profile);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent launchinIntent = new Intent(activity, Profile_Faculty.class);
                    activity.startActivity(launchinIntent);
                }
            });
            Animation anim = new ScaleAnimation(
