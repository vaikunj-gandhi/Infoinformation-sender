...
import com.example.aum.smartyapp.adapter.MessagesAdapter;
 ...
 */
public class AssignmentFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, MessagesAdapter.MessageAdapterListener{

    String GET_JSON_DATA_HTTP_URL = "http://192.168.56.1/Android/displaydata.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
     v=inflater.inflate(R.layout.assignment,container,false);
