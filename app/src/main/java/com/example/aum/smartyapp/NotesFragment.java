 ...
 */
public class NotesFragment extends Fragment  implements  RecyclerAdapter_Notes.MessageAdapterListener {
   // private List<DataItem> listSuperHeroes;
    String GET_JSON_DATA_HTTP_URL = "http://192.168.56.1/Android/notes.php";
    ...
    private RecyclerAdapter_Notes mAdapter;
    TextView t1,t2,t3;
    ...
    private void parseData(String array) throws JSONException {
        ...
        mAdapter = new RecyclerAdapter_Notes( getContext(),messages,this);
