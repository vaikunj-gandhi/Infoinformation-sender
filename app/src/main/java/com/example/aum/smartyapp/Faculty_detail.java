...
public class Faculty_detail extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, FacultyAdapter.MessageAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView v = (TextView) findViewById(R.id.branch);
        SharedPreferences sharedPreferences = this.getSharedPreferences(Config.SHARED_PREF_NAME, Context.MODE_PRIVATE);
        v.setText(sharedPreferences.getString("branch", "Not Available"));
        s_branch = v.getText().toString().trim();
    ...
    private void parseData(String array) throws JSONException {
        ...
        mAdapter = new FacultyAdapter(this, messages, this);
        recyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(new OnItemClickListenerFaculty() {
            @Override
            public void onItemClick(FacultyItem item) {
                Toast.makeText(Faculty_detail.this, item.getEmail(), Toast.LENGTH_LONG).show();
                Intent i = new Intent(Faculty_detail.this, Faculty_detailsHome.class);
    ...
    private int getRandomMaterialColor(String typeColor) {
        ...
        int arrayId = getResources().getIdentifier("mdcolor_" + typeColor, "array", this.getPackageName());
