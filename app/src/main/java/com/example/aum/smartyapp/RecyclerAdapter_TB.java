...
public class RecyclerAdapter_TB extends RecyclerView.Adapter<RecyclerAdapter_TB.MyViewHolder> {
    ...
    public RecyclerAdapter_TB(Context mContext, List<Message> messages, MessageAdapterListener listener) {
